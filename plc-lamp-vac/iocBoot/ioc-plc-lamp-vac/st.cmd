...
epicsEnvSet("IOCNAME", "ioc-plc-lamp-vac" )
epicsEnvSet("ENGINEER", "adpai" )
epicsEnvSet("LOCATION", "PLC:plc_lamp_vac" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_lamp_vac")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_lamp_vac:")
...
save_restoreSet_status_prefix( "PLC:plc_lamp_vac:" )
